...
/* package haskell-messaging-app-0.1.0.0 */
#ifndef VERSION_haskell_messaging_app
#define VERSION_haskell_messaging_app "0.1.0.0"
#endif /* VERSION_haskell_messaging_app */
#ifndef MIN_VERSION_haskell_messaging_app
#define MIN_VERSION_haskell_messaging_app(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_messaging_app */
...
#define CURRENT_PACKAGE_KEY "haskell-messaging-app-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-messaging-app-0.1.0.0-inplace"
